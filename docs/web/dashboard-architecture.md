...
| Pin (session)       | Root and dashboard sessions can be pinned; ordinary child/subagent sessions reject pin requests. Opening a pinned session restores that browser's saved task layout. |
