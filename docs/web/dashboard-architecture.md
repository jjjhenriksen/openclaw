...
| Pin (session)       | Root sessions and dashboard sessions can be pinned; ordinary child/subagent sessions live in their parent's tree and reject pin requests. Opening a pinned session restores that browser's saved task layout. |
